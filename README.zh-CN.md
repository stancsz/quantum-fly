...
![装载神经处理芯片的六足机甲果蝇展开能量护盾迎战量子市场实验](assets/quantum-fly-mecha-chip-hero-v6.png)

**真实果蝇脑图。可选 4 量子比特评分。一个毫不花哨的投资组合对照。**

**这场决斗：**连接组信号对战无图基线。**当前判定：**有界历史研究门槛通过，前瞻优势仍未证明。
...
当前证据快照记录了 **45+ 项本地测试**、**4,096 个 MaleCNS 选定 segment** 和 **160,053 条保留稀疏边**。预注册历史比较通过了有界研究门槛，但这不是前瞻表现或投资有效性证据。命令、分母、限制和分层 GO/NO-GO 决策见[逐项验证记录](docs/VERIFICATION_2026-09-12.md)。
