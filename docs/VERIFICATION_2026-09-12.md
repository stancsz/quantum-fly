...
- `.venv\\Scripts\\python.exe -m pytest -q`: the North Star baseline passed 45 tests; the public-launch demo and clean-receipt fallback add two focused tests, bringing the current suite to 47.
